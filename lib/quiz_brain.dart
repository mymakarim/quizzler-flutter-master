...
class QuizBrain {
  ...
  List<Question> questionBank21 = [
    Question(questionDescription: "You learn that the enemy armed forces have captured a village and are detaining unmarried female residents in order to forcibly marry them as punishment.", question: "Can the enemy force women into prostitution as punishment?", answer: false, answerDescription: "No: Enforced prostitution is prohibited under all circumstances" , questionImg: "assets/images/1211.jpg"),
...
// pashto
  ...
  List<Question> questionBank221 = [
    Question(questionDescription: "تاسو خبريږئ چې د دښمن وسله والو ځواکونو یو کلی نیولی او دوی ناواده انجونې توقیف کوي ترڅو په اجباري توګه ورسره واده وکړي.", question: "ایا دښمن کولی شي د مجازاتو په توګه ښځې فحشا ته اړ کړي؟", answer: false, answerDescription: "نه: اجباري فحشا په هر حالت کې منع ده", questionImg: "assets/images/1211.jpg"),
  ...
  List<Question> questionBank222 = [
    Question(questionDescription: 'ستاسو ډلګی د میرمنو د آزادولو لپاره یو بریالي برید ترسره کړی. تاسو د دښمن ډیر داسې جنګیالي توقیف کړي چې پخپلو کورونو کی یې میرمنې ساتلې او انتظار یی ایستل ترڅو وروسته دوی خپلو ملګرو ته واده کړي. قربانیان غواړي دغه جنګیالیو ته سزا ورکړي. تاسو د قربانیانو سره او همدارنګه د هر هغه ظلم او تیری پخاطر چی دوی ګاللي د خواخوږی احساس کوئ.', question: "ایا تاسو کولی شئ هغه څه وکړئ چې قربانیان یې غواړي او اجازه یې ورکړئ چې بندیان ووهي؟", answer: false, answerDescription: "نه :جسمي سزا حتی د هغه اشخاصو په وړاندې منع ده چې ستاسو او ستاسو د ملاتړ کونکو په وړاندې جرمونه کوي", questionImg: "assets/images/1221.jpg"),
