...
// dari
  ...
  List<Question> questionBank111 = [
    Question(question: "سوال یک: آیا برادر قوماندان یک غیر نظامی است؟", answer: true, answerDescription: "بله: غیرنظامیان افرادی هستند که عضو نیروهای مسلح دولت یا گروههای مسلح سازمان نیستند. کارگران دولت غیر نظامی ملکی هستند.", questionDescription: "پس از عقب نشینی دشمن، به شما دستور داده می شود كه محل سكونت شخصی یك قوماندان دشمن را جستجو كنید. در عین جستجو، شما برادر قوماندان را پیدا می کنید. شما از او تحقیق میکنید و می بینید که او به عنوان منشی وزارت ترانسپورت دولت دشمن کار میکند. ", questionImg: 'assets/images/1111.jpg'),
    Question(question: "سوال ۲: آیا شما میتوانید به او که در حالت فرار است شلیک کنید؟", answer: false, answerDescription: "نخیر: او غیر نظامی است و در جنگ شرکت نمیکند و از حمله مصٔوون میباشد. اما، شما میتوانید سعی به بازداشت او کنید.", questionDescription: "هنگامی که شما مشغول گپ زدن با یکی از همکارتان هستید٫ برادر قوماندان پا به فرار میگذارد. شما او را تعقیب میکنید و هشدار میدهید که بایستد. او به دویدن به سمت درختانی که در نزدیکی موقعیت دارد ادامه میدهد. شما هیچ دلیلی ندارید که ثابت کند او یک تهدید است. ", questionImg: 'assets/images/1112.jpg'),
    Question(question: "سوال ۳: طبق قانون درگیری مسلحانه آیا شما مجاز به شلیک کردن بسوی قوماندان که در حال فرار است٫ هستید؟ ", answer: true, answerDescription: "بله: او عضو نیروهای مسلح است و می تواند در هر زمان مورد حمله قرار گیرد", questionDescription: "شما مبینید که زکو برادر قوماندان را بازداشت می کند. ناگهان متوجه مشوید که قوماندان دشمن از یک راه  زیرزمین از خانه فرارمیکند. به نظر نمی رسد که او مسلح باشد.", questionImg: 'assets/images/1113.jpg'),
  ];

  List<Question> questionBank112 = [
    Question(question: "سوال یک: آیا شما میتوانید او را به جرم کمک به دشمن بکشید؟", answer: false, answerDescription: "نخیر: امتناع از ارائه اطلاعات مشارکت مستقیم در خصومت نیست. فقط غیرنظامیانی که مستقیماً در خصومت ها شرکت می کنند ممکن مورد حمله قرار گیرند." , questionDescription: "شما در حال پیش قدمی بسوی یکی از شهرهای که تحت کنترول دشمن میباشد هستید، ولی اطلاعات استخباراتی نشان میدهد که غیر نظامیان این شهر به دشمنان شما کمک میکنند. شما یکی از غیر نظامیان را متوقف و از او خواستار معلومات در رابطه به مواضع دشمن در شهر میشوید. ولی وی به شما جواب نمیدهد." , questionImg: "assets/images/1121.jpg"),
    Question(question: "سوال دوم: آیا قانون درگیری مسلحانه به شما اجازه میدهد که شخصی را که عقب درخت است مورد هدف قرار دهید؟", answer: true, answerDescription: "بله: شما شواهد منطقی دارید که نشان میدهد او مستقیماً در خصومت ها شرکت دارد." , questionDescription: "شما یک شخص را با لباس غیرنظامی در پشت یک درخت مشاهده می کنید. او با یک بیرق سرخ به سمت شما اشاره میکند و بلافاصله دشمن شروع به شلیک کردن به سوی شما میکند." , questionImg: "assets/images/1122.jpg"),
    Question(question: "سوال سوم: آیا شما میتوانید به دکان حمله کنید؟", answer: false, answerDescription: "نخیر: دکان یک هدف نظامی نیست و فقط به اهداف نظامی میتوان حمله کرد. (یعنی به اهدافی که در اقدامات نظامی دشمن نقش مؤثری دارند و خنثی سازی آنها در آن زمان به شما یک مزیت نظامی قطعی میدهد میتوان حمله کرد)" , questionDescription: "به شما اطلاع میرسد که جنگجویان دشمن درحال خریدن سیگرت از یکی از دکان ها در حاشیه شهرهستند. شما می خواهید عرضه سیگار آنها را مختل کنید چون شما میدانید که این موجب از دست دادن روحیه آنها میشود. " , questionImg: "assets/images/1123.jpg"),
  ];
  List<Question> questionBank113 = [
    Question(question: "سوال اول: آیا می توانید جنرال را به عنوان یک هدف مشروع در نظر بگیرید؟", answer: true, answerDescription: "بله: جنرال میتواند یک هدف مشروع باشد چون او عضو قوای مسلح میباشد و از حملات مصؤون نمیباشد " , questionDescription: "شما در حال انجام مبارزات چریکی درشهری که در کنترول دشمن است هستید. قوماندان به شما هدایت میدهد که با نزدیک شدن به جاده، یک بمب کنترل شده را جهت مورد هدف قراردادن یک جنرال اردوی دشمن که در حال بازدید است، منفجر سازید." , questionImg: "assets/images/1131.jpg"),
    Question(question: "سوال دوم: آیا اکنون نیاز دارید تا اوضاع را ارزیابی و در مورد اینکه آیا ممکن به جنرال حمله کنید, تصمیم گیری نمائید؟", answer: true, answerDescription: "بله:  شما باید وضعیت را ارزیابی کنید. نباید تلفات غیرنظامیان این حمله در مقایسه با مزیت نظامی بیشتر باشد. " , questionDescription: "به شما اطلاع میرسد که اردو از رانندگان غیرنظامی جهت رانندگی برای افسران عالی رتبه خود استفاده میکند. " , questionImg: "assets/images/1132.jpg"),
    Question(question: "سوال سوم: آیا می توانید طبق پلان قبلی ادامه داده و حمله را انجام دهید؟ ", answer: false, answerDescription: "نخیر:  شرایط تغییر کرده است. شما باید حمله را لغو کنید تا از تلفات بیش از حد غیرنظامی جلوگیری شود." , questionDescription: "شما تصمیم میگیرید تا به کار جابجا نمودن بمب ادامه دهید. به محض نزدیک شدن جیپ، شما متوجه بس مکتب که پر از کودک است و از سمت مخالف در حال نزدیک شدن است، میشوید. آنها همزمان با انفجار بمب عبور خواهند کرد." , questionImg: "assets/images/1133.jpg"),
  ];
  List<Question> questionBank114 = [
    Question(question: "سوال اول: آیا سلاح ها برای دشمن اهداف نظامی اند؟", answer: true, answerDescription: "بله: دشمن میتواند آنها را مورد حمله قراردهند." , questionDescription: "قوماندان به شما دستور می دهد تا سلاح ها را برای محافظت ذخیره کنید." , questionImg: "assets/images/1141.jpg"),
    Question(question: "سوال دوم: آیا شما میتوانید قبول کنید و سلاح ها را در خانه همسایه غیرنظامی خود پنهان میکنید؟ ", answer: false, answerDescription: "نخیر: شما باید هر کاری را انجام دهید تا از قرار دادن اشیای نظامی خود در میان غیرنظامیان خودداری کنید، حتی اگر آنها موافقت کنند." , questionDescription: "پیدا کردن یک مکان ذخیره سازی امن دشوار است. شما با همسایه غیرنظامی خود که از مبارزه شما حمایت میکند، چای مینوشید و به مسئله خود اشاره میکنید. او پیشنهاد میکند که سلاح ها را در خانه خود که در آن همراه همسر و ۵ فرزندش زندگی میکند، پنهان نماید." , questionImg: "assets/images/1142.jpg"),
    Question(question: "سوال سوم: آیا شما میتوانید اسلحه را در کارخانه متروکه در حاشیه شهر بگذارید؟", answer: true, answerDescription: "بله: حتی اگر این کارخانه یک هدف غیرنظامی باشد، شما می توانید تحت چنین شرایطی اهداف نظامی خود را از میان مردم غیرنظامی بردارید." , questionDescription: "همسایه شما از این که پیشنهادش را رد کردید نارحت است ولی این بار پیشنهاد میکند که اسلحه را در کارخانه متروکه در حاشیه شهر بگذارید." , questionImg: "assets/images/1143.jpg"),
  ];
  List<Question> questionBank115 = [
    Question(questionDescription: "یک خبرنگار تلویزیون محلی برای نمایش تبلیغات علیه سازمان شما از برنامه خود استفاده میکند. قوماندان شما نگران از دست دادن حمایت در جامعه است و به شما دستور می دهد تا کاری را برای ساکت نمودن وی انجام دهید.", question: "سوال اول: آیا شما میتوانید خبرنگار را مورد هدف قرار دهید؟", answer: false, answerDescription: "نخیر: گرچه تبلیغات وی زیانبار است، اما به معنای مشارکت مستقیم در مخاصمات و جنگ نیست، چنانچه خبرنگار را نمیتوان مورد حمله قرار داد", questionImg: "assets/images/1151.jpg"),
  ...
  List<Question> questionBank121 = [
    Question(questionDescription: "شما مطلع می شوید که نیروهای مسلح دشمن یک قریه را تحت تسلط خود در آورده و آنعده دخترانی را که مجرد اند توقیف میکنند تا بتوانند به عنوان مجازات با آنها طور اجباری ازدواج کنند.", question: "سوال ۱: آیا دشمن میتواند زنان را به عنوان مجازات وادار به ازدواج کنند؟ ", answer: false, answerDescription: "نخیر: ازدواج اجباری تحت هر شرایطی ممنوع است. ", questionImg: "assets/images/1211.jpg"),
    Question(questionDescription: "زکو پیشنهاد میکند که سازمان شما تا زمانیکه دولت دشمن موافقت به توقف عمل خود نکند، ازدواج اجباری با زنان اقارب قوماندانان دشمن را آغاز کند. وی میگوید که این رفتار غیر انسانی نیست زیرا هدف فقط متوقف کردن شکنجه خواهران است.", question: "سوال ۲: آیا سازمان شما میتواند جهت جلوگیری از بدرفتاری دشمن اجازه ازدواج اجباری با زنان اقارب مسؤولین دشمن را بدهد؟  ", answer: false, answerDescription: "نخیر: رفتار غیر انسانی - از جمله ازدواج اجباری - تحت هر شرایطی بدون هیچ بهانه ای ممنوع است ، حتی اگر هدف از این کار جلوگیری از بدرفتاری های دشمن باشد.", questionImg: "assets/images/1212.jpg"),
    Question(questionDescription: "زکو طرحی جدید دارد. او می گوید اگر نمی توانید با زنان دشمن طور اجباری ازدواج کنید ، حداقل می توانید تهدید کنید که این کار را انجام خواهید داد. ", question: "سوال ۳: آیا سازمان شما جهت جلوگیری از بدرفتاری دشمن می تواند تهدید به ازدواج اجباری با زنان دشمن را کند؟", answer: false, answerDescription: "نخیر: تهدید به رفتار غیر انسانی ممنوع است.", questionImg: "assets/images/1213.jpg"),
  ];
  List<Question> questionBank122 = [
    Question(questionDescription: 'واحد شما برای آزاد ساختن زنان یک حمله موفقیت آمیز انجام داده است. شما چندین جنگجوی دشمن را که در نگه داشتن زنان در محوطه شان دست داشتند و منتظر بودند تا بتوانند آنان را به عنوان همسران به رفقایشان اهدا کنند، بازداشت می کنید. قربانیان می خواهند آنها را مجازات كنند. شما نسبت به قربانیان و تمام آنچه را که متحمل شده اند، احساس همدردی می کنید.', question: "سوال ۱: آیا می توانید خواست قربانیان را قبول نموده و اجازه دهید تا بازداشت شدگان را شلاق بزنند؟", answer: false, answerDescription: "نخیر: مجازات بدنی حتی در برابر افرادی که علیه شما یا طرفداران شما مرتکب جرم میشوند ممنوع است", questionImg: "assets/images/1221.jpg"),
    Question(questionDescription: "قربانیان خواهان انصاف هستند. آنها از سازمان شما میخواهند که عاملان را به جرم جنایت جنگی ازدواج اجباری محاکمه کند.", question: "آیا سازمان شما میتواند محاکمه را انجام دهد؟ ", answer: true, answerDescription: "بله:  اما محاکمه باید منصفانه ، مستقل و بی طرف باشد و ضمانت های اساسی قضایی را مدنظر گیرد، بدون این محاکمه شان ممنوع است", questionImg: "assets/images/1222.jpg"),
  ...
  List<Question> questionBank123 = [
    Question(questionDescription: "یکی از بازداشت شدگان درجهٔ بالا دشمن تأکید میکند که وی حق دارد مطابق معیارهای معمول خود تغذیه شود. او خواستار ضیافت است", question: "سوال ۱: آیا شما مکلف به فراهم نمودن غذا با شرایطی که بازداشت شده گان به آن عادت دارند هستید؟ ", answer: false, answerDescription: "نخیر: اما شما باید با استانداردهای که به پرسنل خود غذا تأمین می کنید به آنها غذا ارائه دهید", questionImg: "assets/images/1231.jpg"),
  ...
  List<Question> questionBank124 = [
    ...
    Question(questionDescription: "بازداشت شدگان اجازه ادای نماز را میخواهند. قربانیان پاسخ می دهند كه بازداشت شدگان به خدا توهین كرده اند و حق عمل به دین خود را از دست داده اند", question: "سوال ۳: آیا می توانید بازداشت شدگان را از عمل به دین خود محروم کنید؟", answer: false, answerDescription: "نخیر: به هر عمل دینی باید احترام شود. ", questionImg: "assets/images/1243.jpg"),
  ];
  ...
  List<Question> questionBank131 = [
    ...
    Question(questionDescription: "دشمن  هوشیاراست و به دام شما نمی افتد. زکو پلان دیگری دارد. واحد شما وانمود میکند که میخواهد تسلیم شود و سپس دشمن را به شکل غافلگیر کننده به دام میاندازد.", question: "سوال ۲: آیا شما میتوانید وانمود به تسلیم شدن برای حمله به دشمن کنید؟", answer: false, answerDescription: "نخیر : این خدعه خاینانه میباشد. شما نمی توانید از حمایت هایی که توسط قانون جنگ برای کسانی که تسلیم شده اند بهره ببرید و سپس به دشمن حمله کنید", questionImg: "assets/images/1312.jpg"),
    Question(questionDescription: "قوماندان شما بین مکر قانونی و نیرنگ غیرقانونی مغشوش است. او شما را به دفتر خود فرا میخواند و میپرسد:", question: "سوال ۳: آیا این نیرنگ غیر مشروع است که اول وانمود به غیرنظامی بودن کنید و سپس به دشمن حمله آور شوید؟", answer: true, answerDescription: "بله: جعل حالت غیرنظامی برای حمله به دشمن  سوء استفاده از مصوونیت وضعیت غیرنظامی است که ممنوع میباشد.", questionImg: "assets/images/1313.jpg"),
  ];
  List<Question> questionBank132 = [
    ...
    Question(questionDescription: "شما به گشت زنی ادامه می دهید و با دشمن دیگری روبرو می شوید که اسلحه خود را تسلیم می کند. می دانید که باید عمل تسلیم شدن را بپذیرید ، اما پس از تجربه قبلی خود، به دشمن مشکوک هستید", question: "سوال ۳:آیا مشکوک بودن, به شما اجازه شلیک به دشمن را میدهد؟", answer: false, answerDescription: "نخیر: تازمانیکه شخص قصد انجام عمل خصومت آمیز را نکند او مصؤون می باشد. ", questionImg: "assets/images/1323.jpg"),
  ];
  ...
  List<Question> questionBank134 = [
    Question(questionDescription: "دشمن ناامید می شود. آنها موقعیت های شلیک را در خانه های غیرنظامی قرارداده اند. شما نمیتوانید بدون ایجاد تلفات بیش از حد غیرنظامی به طور مؤثر حمله کنید. شما پیشنهاد می کنید تا زنجیره تأمین دشمن را قطع کنید تا آنها را مجبور کنید از شهر بیرون شوند", question: "سوال ۱: ایا می توانید زنجیره تأمین دشمن را قطع کنید؟", answer: true, answerDescription: "بله: این یک روش جنگی مشروع است", questionImg: "assets/images/1341.jpg"),
    Question(questionDescription: "دشمن در حال گرفتن آب از منبع آب است که تنها منبع آب آشامیدنی پاک در شهر است. وقتی دشمن از تأمین آب برای مزیت نظامی خود استفاده می کند، شما تأیید می کنید که این امر به یک هدف نظامی تبدیل شده است", question: "سوال ۲:آیا می توانید منبع آب را خراب کنید؟", answer: false, answerDescription: "نخیر: با آنکه آبرسانی میتواند یک هدف قانونی باشد، حمله به اشیای که برای زنده ماندن غیرنظامیان ضروری هستند ممنوع است", questionImg: "assets/images/1342.jpg"),
  ...
  List<Question> questionBank143 = [
    Question(questionDescription: "دوست دارید حرکات دشمن را در مسیر جنگل مختل کنید. می دانید که سازمان شما استفاده از مین های ضد پرسنلی را ممنوع اعلام کرده است. شما مطمئن نیستید که این ممنوعیت مانع از منفجر شدن مین ها با کنترل از راه دور هنگام مشاهده دشمن در مسیر می شود", question: "سوال ۱:آیا می توانید از ماین های که توسط ریموت کنترول فعال و منفجر میشوند استفاده کنید؟", answer: true, answerDescription: "بله:از ماین های هدایت شده با ریموت کنترل از راه دور می توان استفاده کرد ، اما فقط در برابر اهداف قانونی ، با استفاده از همه اقدامات احتیاطی و جلوگیری از صدمه دیدن بیش از حد غیرنظامی ", questionImg: "assets/images/1431.jpg"),
    Question(questionDescription: "زکو می گوید نشستن در اطراف در انتظار دشمن در این مسیر خسته کننده و خطرناک است. وی پیشنهاد می کند که با استفاده از وسایل خانگی ماین ساخته شود، که به همان روش مین ضد پرسونل منفجر شوند. به این ترتیب می توان ممنوعیت را دور زد", question: "سوال ۲:آیا می توانید از وسایل خانگی که مانند مین های ضد پرسونل در اثر تماس قربانی فعال و منفجر میشوند استفاده کنید؟", answer: false, answerDescription: "خیر: استقاده از دستگاه هایی که مانند ماین ضد پرسونل عمل می کنند نیز ممنوع است", questionImg: "assets/images/1432.jpg"),
    Question(questionDescription: "مسیر جنگلی از انتهای جاده شروع می شود. زکو شما را متقاعد می کند که ماین گذاری جاده با ماین های ضد وسایل نقلیه برای جلوگیری از استفاده دشمن از مسیر کافی خواهد بود. وی مفتخر است که به شما اطلاع دهد كه ماین های ضد وسایط ممنوع نیستند. او به شما می گوید که هیچ غیرنظامی هرگز از جاده استفاده نمی کند ، بنابراین می توانید آنرا ماین گذاری نموده و فراموش کنید", question: "سوال ۳ :اگر از مین های ضد وسایل نقلیه استفاده می کنید ، آیا باید از محلی که آنها را قرار داده اید ، سوابق و نقشه داشته باشید؟", answer: true, answerDescription: "بله:قرار دادن ماین ها باید در هر زمان ممکن ثبت شود. این به پاکسازی ماین در آینده و بازگشت به حالت عادی در پایان جنگ کمک خواهد کرد", questionImg: "assets/images/1433.jpg"),
  ];
  ...
  List<Question> questionBank161 = [
    Question(questionDescription: "زکو بسیار هیجان زده است. او کشف کرده است که شفاخانه محلی در حال معالجه جنگجویان زخمی دشمن است. او می خواهد شفاخانه را تخریب کند تا دیگر نتواند به دشمن کمک کند", question: "سوال۱:آیا می توانید شفاخانه را که در حال معالجه جنگجویان زخمی دشمن است مورد هدف قرار دهید؟", answer: false, answerDescription: "نخیر: شفاخانه ها را حتی در حالت معالجه مجروحان دشمن نمیتوان مورد حمله قرارداد", questionImg: "assets/images/1611.jpg"),
    Question(questionDescription: "مرکز قومانده شما هدف آتش توپخانه دشمن قرار میگیرد. شما متوجه می شوید که آتش از موقعیت توپخانه دشمن که در شفاخانه قرار دارد بسوی شما میاید", question: "سوال ۲:آیا می توانید شفاخانه را مورد هدف قرار دهید با اینکه متوجه می شوید که از آن به عنوان موقعیت شلیک توپخانه استفاده می شود؟", answer: false, answerDescription: "نخیر: شفاخانه از محافظت خاص برخوردار میباشد و نمیتوان بدون دادن هشدار به دشمن به آن حمله نمود. ", questionImg: "assets/images/1612.jpg"),
    Question(questionDescription: "شما به قوماندان خود اطلاع می دهید، وی به دشمن هشدار صادر می کند که استفاده از شفاخانه برای انجام حملات را متوقف کنند و او برای این کار مهلت تعیین میکند. باوجود گذشت مهلت دشمن حملات خود را متوقف نمیکند", question: "سوال ۳: آیا قانون درگیری مسلحانه هدف قرار دادن شفاخانه را اجازه میدهد؟", answer: true, answerDescription: "بله:اگر از شفاخانه ها برای ارتکاب اقدامات خصمانه استفاده شود و هشدارهای فراوان را نادیده بگیرند، شفاخانه ها مصوونیت ویژه خود را از دست می دهند. اما شما باید اقدامات احتیاطی را برای جلوگیری یا به حداقل رساندن خسارات غیرنظامی و جلوگیری از تلفات غیرنظامیان اتخاذ کنید", questionImg: "assets/images/1613.jpg"),
  ];
  ...
  List<Question> questionBank162 = [
    ...
    Question(questionDescription: 'زکو می گوید: "خوب حداقل اجازه دهید  خونریزی او دوام کند."', question: "سوال ۲: آیا می توانید یک جنگجو دشمن را بگذارید تا دم مرگ خونریزی کند؟", answer: false, answerDescription: "نخیر: شما باید در اسرع وقت به همه مجروحان - چه دوست باشد یا دشمن - خدمات طبی مهیا کنید", questionImg: "assets/images/1622.jpg"),
    Question(questionDescription: "شما زکو و زرمنده دشمن هر دو را به مراقبت های طبی می رسانید.  داکتر تصمیم می گیرد که دشمن به توجه بیشتری نیاز دارد.  زکو به داکتر دستور می دهد که ابتدا زخم او را معالجه کند", question: "سوال ۳: آیا زکو می تواند به  داکتر دستور دهد تا درمان زخم جزئی او را در اولویت قراردهد؟", answer: false, answerDescription: "نخیر:  اولویت درمان فقط براساس نیاز است", questionImg: "assets/images/1623.jpg"),
  ];
  List<Question> questionBank163 = [
    ...
    Question(questionDescription: "شما به نانوا می گویید که نمادها را حذف کند. روز دیگر وقتی نانوا به پوسته بازرسی میرسد، نشان ها هنوز آنجا هستند. او می گوید که کمک های غذایی را به غیرنظامیان میرساند بنابراین حق دارد که از این نمادها استفاده کند", question: "سوال ۲: آیا نانوا می تواند از نمادهای صلیب سرخ و هلال احمر برای رسانیدن کمکهای بشردوستانه استفاده کند؟", answer: false, answerDescription: "نخیر : فقط افراد مجاز می توانند از نمادهای صلیب سرخ یا هلال احمر استفاده کنند", questionImg: "assets/images/1632.jpg"),
    Question(questionDescription: "روز بعد زکو در یک آمبولانس که دارای نشان هلال احمر است به پوسته تلاشیشما نزدیک می شود. او به شما چشمک می زند و می گوید دشمن هرگز نخواهد دانست چه چیزی به آنها ضربه زده است", question: "سوال ۳ : آیا زکو می تواند از آمبولانس که دارای نشان هلال احمر است برای حمله به دشمن استفاده کند؟", answer: false, answerDescription: "نخیر : استفاده نادرست از نمادهای صلیب سرخ یا هلال احمر ممنوع است", questionImg: "assets/images/1633.jpg"),
  ];

  List<Question> questionBank164 = [
    Question(questionDescription: "باران در حال باریدن است.  شما تر و حالت بدی دارید. یک لاری به پوسته شما نزدیک می شود", question: "سوال۱:آیا می توانید جلوی لاری را بگیرید؟", answer: true, answerDescription: "بله: شما میتوانید حرکت وسایل نقلیه را کنترل کنید", questionImg: "assets/images/1641.jpg"),
  ...
  List<Question> questionBank171_1 = [
    Question(questionDescription: "واحدی که تحت قومانده شما است وظیفه محافظت از چار اطراف کمپ بیجاشده گان را دارد. زکو به شما می گوید که بیجاشده گان بیشتر محافظت خواهند شد اگر سربازان داخل کمپ مستقر شوند", question: "سوال۱:آیا سربازان می توانند داخل کمپ مستقر شوند؟", answer: false, answerDescription: "نخیر: صفت و خاصیت غیرنظامی و بشردوستانه کمپ های بیجاشده گان باید همیشه مورد احترام باشند", questionImg: "assets/images/17111.jpg"),
    Question(questionDescription: "	زکو می گوید مردم در کمپ باید در بخش کمک به سربازان این کشور برای محافظت از آنها سهیم باشند. آنها باید هر بار که از کمپ خارج می شوند ، مالیات بپردازند", question: "سوال ۲:  آیا سربازان می توانند دربدل امنیت پول بخواهند؟", answer: false, answerDescription: "نخیر: بیجاشده گان داخلی حق دارند که آزادانه در کمپ رفت و آمد کنند", questionImg: "assets/images/17112.jpg"),
  ];
  List<Question> questionBank171_2 = [
    Question(questionDescription: "شما به یک کافه در این نزدیکی می روید تا تعدادی از استخدام شونده گان جدید را که تازه به شما اختصاص داده شده اند انتخاب کنید. آنها شروع به آزار و اذیت گارسون میکنند و به او میگویند که باید وظیفه خود را در قبال مبارزه انجام دهد. آنها می گویند که همانطور که آنها قربانی میدهند او هم باید قربانی بدهد. ", question: "سوال۳: آیا مردان می توانند گارسونها را وادار به رابطه جنسی کنند؟", answer: false, answerDescription: "نخیر: تجاوز و انواع دیگر خشونت جنسی تحت هر شرایطی ممنوع است. جنگ نیز از این قاعده مستثنی نیست.", questionImg: "assets/images/17122.jpg"),
    Question(questionDescription: "مردان شما را تشویق می کنند که به آنها بپیوندید. شما امتناع می کنید و دستور می دهید که آنها از این کار دست بکشند. آنها لبخند می زنند و چون کافه خالی است، به شما می گویند که حداقل در حالی که تفریح میکنند، مراقب دروازه باشید.", question: "سوال ۴: آیا این یک تخلف است اگر مشارکت نکنید بلکه فقط محافظ باشید؟", answer: true, answerDescription: "بله :کمک به تخلف کننده نیز شرکت در تخلف شمرده میشود.", questionImg: "assets/images/17123.jpg"),
    Question(questionDescription: "شما از نگهبانی خودداری می کنید. مردان خشونت می کنند. آنها شما را از کافه بیرون میاندازند و به شما می گویند که به کمپ خود برگردید و همه چیز را فراموش کنید. آنها در را کوبیده و قفل میکنند", question: "سوال ۵: آیا می توانید به خانه بروید و همه چیز را فراموش کنید؟", answer: false, answerDescription: "خیر:اگر قادر به جلوگیری از تخلف نیستید ، باید تخلف را به قوماندانان بلند پایه خود گزارش دهید", questionImg: "assets/images/17123.jpg"),
  ];
  List<Question> questionBank172_1 = [
    ...
    Question(questionDescription: "شما در حال پهره داری هستید. شما فقط برای یک ثانیه خواب میروید، هنگامی که از متوجه حرکت میشوید. شما یک فرد را با یونیفارم دشمن می بینید. او اسلحه حمل می کند و به وضوح در حال گشت زنی است.", question: "سوال ۲: طبق قانون درگیری مسلحانه آیا هدف قرار دادن فرد مذکور مجاز است؟", answer: true, answerDescription: "بله: او عضو نیروهای مسلح دشمن است. او در برابر حمله مصوونیت ندارد.", questionImg: "assets/images/17212.jpg"),
    Question(questionDescription: "آن فرد شما را میبیند و در جستجوی پناه میشود. اسلحه او در شاخ درخت گیر میماند و او نمی تواند آن راازدرخت جدا کند. او به درون جنگل فرار می کند و اسلحه خود را پشت سر میگذارد.", question: "سوال ۳: حال که او اسلحه خود را گم کرده است، آیا اکنون می توانید او را مورد هدف قرار دهید؟", answer: true, answerDescription: "بله: او هنوز هم عضو نیروهای مسلح است که در جنگ شرکت میکند.", questionImg: "assets/images/17213.jpg"),
  ];
  ...
  List<Question> questionBank172_2 = [
    ...
    Question(questionDescription: 'پایان یک تابستان خشک طولانی است. زکو می گوید: "بیایید جنگل را بسوزانیم. آنها یا ذغال سنگ خواهند شد یا مبدل به سلاح ما خواهند گشت. " این کار را زمانی خواهیم کرد که بچه ها در مکتب هستند بنابراین می دانیم که آنها در جنگل نخواهند بود. "', question: "سوال ۵: آیا با آتش زدن جنگل می توانید به دشمن حمله کنید؟ ", answer: false, answerDescription: "نخیر : استفاده از محیط طبیعی به عنوان سلاح ممنوع است", questionImg: "assets/images/17222.jpg"),
  ];
  ...
  List<Question> questionBank173_2 = [
    Question(questionDescription: "شما عقب نشینی میکنید و به پوسته امنیتی میرسید که توسط اعضای گروه شما اداره میشود. وی به شما سلامی میکند. شما ملاحظه میکنید که وی از عبور کاروان کمکهای بشری جلوگیری میکند، مگر اینکه راننده کمپل های را به نیروهای شما برای گرم ماندن در شب بدهد", question: "سوال۴: آیا امدادرسان موظف است کمپل ها را تحویل دهد؟ ", answer: false, answerDescription: "نخیر: منحرف کردن کمکهای بشردوستانه برای استفاده نظامی ممنوع است", questionImg: "assets/images/17321.jpg"),
    Question(questionDescription: "شما به زکو می گویید که به نگهبان بگویید که به  کمکها اجازه عبور را بدهد، اما او برمی گردد و می گوید نگهبان به او گوش نمیدهد. شما بسیار مشغول سازماندهی عقب نشینی هستید و وقت لازم برای رسیدگی به همه چیز را ندارید", question: "سوال ۵:آیا می توانید با دانستن اینکه سعی کردید تخلف توسط زیردست خود را متوقف کنید به کارهای خویش ادامه دهید؟", answer: false, answerDescription: "نخیر: شما باید برای جلوگیری از تخلف توسط زیردستان، هر کاری را انجام دهید", questionImg: "assets/images/17322.jpg"),
  ];

  List<Question> questionBank174_1 = [
    Question(questionDescription: "دشمن ادعا می کند که غیرنظامیانی که علناً از سازمان شما در رسانه ها حمایت می کنند تروریست هستند ، بنابراین می توانند مورد حمله قرار گیرند", question: "سوال ۱: آیا دشمن می تواند به غیرنظامیان که ادعا می شود تروریست هستند حمله کند درصورتیکه این غیرنظامیان در جنگ شرکت ندارند؟", answer: false, answerDescription: "نخیر: هدف قرار دادن غیرنظامیانی که درخصومتها شرکت نمی کنند غیرمجاز است", questionImg: "assets/images/17411.jpg"),
    ...
    Question(questionDescription: 'شما زکو را متقاعد می کنید که یک روزنامه نگار را به قصد انتقام نکشد، اما بعداً او می گوید ، "در این صورت من حق دارم همسر قوماندان قطعه را که پدرم را کشته است، به قتل برسانم. او هم دشمن است"', question: "سوال ۳: آیا زکو میتواند غیرنظامی را که عضو خانواده جنگجو دشمن است، بکشد؟", answer: false, answerDescription: "نخیر:کشتار غیرنظامیان یک جنایت جنگی است، بشمول کشتن اعضای خانواده جنگجو دشمن", questionImg: "assets/images/17413.jpg"),
  ];
  List<Question> questionBank174_2 = [
    Question(questionDescription: "زکو عصبانی است. او از شما می خواهد كه شما مأموریت دهید كه به واحد دشمن كه پدرش را كشته است حمله كند", question: "سوال ۴:    طبق قانون درگیری مسلحانه آیا شما اجازه دارید تا واحد نظامی دشمن را که پدر زکو را کشته است، مورد هدف قرار دهید؟", answer: true, answerDescription: "بله:  اعضای نیروهای مسلح اهداف مشروع هستند و از حمله در امان نیستند", questionImg: "assets/images/17421.jpg"),
  ...
  List<Question> questionBank175_1 = [
    Question(questionDescription: "شما اطلاعاتی را درمورد مسیری که جنرال دشمن در آن سفر خواهد کرد دریافت میکنید. شما برای اسیر کردن او حمله ای را پلان می کنید. اما بعداً می فهمید که یک تیم ۱۰ نفره پولیس امنیت او را تأمین می کند", question: "سوال ۱: با مشاهده حضور پولیس، آیا بازهم می توانید این حمله را انجام دهید؟", answer: true, answerDescription: "بله : پولیس معمولاً غیرنظامیان محافظت شده محسوب میشوند، اما به علت محافظت از جنرال، آنها مستقیماً در درگیری ها شرکت می کنند و مصوونیت خود را از دست می دهند", questionImg: "assets/images/17511.jpg"),
    Question(questionDescription: 'شما با کمین ادامه می دهید و جنرال را اسیر می کنید. پسر کاکایش که یک عالم مشهور دینی است نیز با او در موتر است. زکو می گوید اگر او را نگه دارید، دشمن جرات نخواهد کرد که به یک عالم دینی مشهور حمله کند. او می گوید: "از هرگونه تخلف نگران نباشید ، من با او مانند شاهزاده رفتار خواهم کرد و اجازه نمی دهم کسی به ضرر رساند."', question: "سوال ۲: اگر با عالم دین رفتار خوبی کنید، آیا می توانید برای جلوگیری از حمله دشمن به نیروهایتان، او را نگه دارید؟", answer: false, answerDescription: "نخیر: استفاده از انسان به عنوان سپر ممنوع است", questionImg: "assets/images/17512.jpg"),
    Question(questionDescription: "جنرال به شانه خود زخمی بر داشته است که درد شدیدی دارد. داکتر به شما اطلاع می دهد که فقط برای سربازان شما داروهای کافی وجود دارد", question: "سوال ۳:آیا می توانید برای صرفه جویی در داروی خود ، معالجهً جنرال را انکار کنید؟", answer: false, answerDescription: "نخیر:  اولویت طبی فقط بر اساس نیاز انجام می شود", questionImg: "assets/images/17513.jpg"),
  ];
  List<Question> questionBank175_2 = [
    Question(questionDescription: "قوماندان عالیرتبه از طریق مخابره به شما زنگ میزند و میگوید که جنرال دارای اطلاعات بسیار مهم است. به دلیل ضرورت نظامی در این شرایط استثنایی، وی به شما اجازه می دهد تا جنرال را شکنجه کنید ، اما فقط در حد ضرورت", question: "سوال ۴: آیا شما می توانید جنرال را تحت این شرایط استثنایی شکنجه نمایید درصورتیکه تنها از حداقل نیروی لازم استفاده کنید؟", answer: false, answerDescription: "نخیر: شکنجه هرگز مجاز نیست. هیچ عذری نمیتواند آنرا توجیه کند", questionImg: "assets/images/17521.jpg"),
...
// pashto
  ...
  List<Question> questionBank212 = [
    ...
    Question(question: "دوهمه پوښتنه: آیا د وسله والې جګړې قانون تاسو ته اجازه درکوي چې د ونې شاته کس په نښه کړئ؟", answer: true, answerDescription: "هو :تاسو معقول باور لرئ چې هغه په مستقیم ډول په جنګ کې برخه اخلي." , questionDescription: "تاسو د ونو تر شا په ملکي جامو کې یو کس ګورئ. هغه د یو سور بیرغ پواسطه ستاسو پر لور اشاره کوی او سمدلاسه دښمن پر تاسو ډزې پیلوي." , questionImg: "assets/images/1122.jpg"),
  ...
  List<Question> questionBank221 = [
    Question(questionDescription: "تاسو خبريږئ چې د دښمن وسله والو ځواکونو یو کلی نیولی او دوی ناواده انجونې توقیف کوي ترڅو په اجباري توګه ورسره واده وکړي.", question: "لومړۍ پوښتنه : آیا دښمن کولای شي د مجازاتو په توګه ښځې واده کولو ته اړې کړي؟", answer: false, answerDescription: "نه: اجباري واده په هر حالت کې ممنوع دی.", questionImg: "assets/images/1211.jpg"),
    Question(questionDescription: "زکو وړاندیز کوي چې ستاسو سازمان تر هغه وخته پورې د دښمن قوماندانانو د ښځینه خپلوانو سره اجباری ودونه وکړي ترڅو چې دښمن حکومت د خپل عمل څخه لاس په سر شی . هغه وايي چې دا غیر انساني چلند نه دی ځکه چې هدف یې یواځې ستاسو د خويندو د شکنجې بندول دي.", question: "دوهمه پوښتنه : آیا ستاسو سازمان کولای شي د دښمن د خپلوانو سره جبری ودونه وکړي تر څو د دښمن د شکنجي مخه ونیسی؟", answer: false, answerDescription: "نه: غیر انساني چلند -  د جبری واده په شمول - په هر حالت کې منع دي او هیڅ عذر جواز نلری، حتی که هدف یې د دښمن شکنجي مخنیوی وي.", questionImg: "assets/images/1212.jpg"),
    Question(questionDescription: "زکو نوی پلان لري. هغه وايي که په حقیقت کې تاسو نشئ کولای د دښمن د ښځینه خپلوانو سره جبری ودونه وکړئ، تاسو لږترلږه د دې کار د کولو ګواښ کولائ شی.", question: "دریمه پوښتنه : آیا ستاسو سازمان کولای شي د دښمن د شکنجي د مخنیوي لپاره د دښمن چارواکو د خپلوانو سره د جبری واده ګواښ وکړي؟", answer: false, answerDescription: "نه: د غیر انساني چلند ګواښ منع دی.", questionImg: "assets/images/1213.jpg"),
  ];

  List<Question> questionBank222 = [
    Question(questionDescription: 'ستاسو ډلګی د میرمنو د آزادولو لپاره یو بریالي برید ترسره کړی. تاسو د دښمن ډیر داسې جنګیالي توقیف کړي چې پخپلو کورونو کی یې میرمنې ساتلې او انتظار یی ایستل ترڅو وروسته دوی خپلو ملګرو ته واده کړي. قربانیان غواړي دغه جنګیالیو ته سزا ورکړي. تاسو د قربانیانو سره او همدارنګه د هر هغه ظلم او تیری پخاطر چی دوی ګاللي د خواخوږی احساس کوئ. ', question: "لومړۍ پوښتنه: آیا تاسو کولای شئ د هغه څه اجازه ورکړئ چې قربانیان یې غواړي او دوی پریږدئ چې بندیان په دوره ووهي؟", answer: false, answerDescription: "نه :جسمي سزا ممنوعیت لری حتی د هغو اشخاصو چې ستاسو او ستاسو د ملاتړ کونکو په وړاندې یی جرمونه ترسره کوي.", questionImg: "assets/images/1221.jpg"),
    Question(questionDescription: "قربانیان د عدالت غوښتنه کوي. دوی غوښتنه کوي چې ستاسو سازمان د جبری واده په څير د جنګی جرم مرتکبین محاکمه کړي.", question: "دوهمه پوښتنه : آیا ستاسو سازمان کولای شي محاکمه ترسره کړي؟", answer: true, answerDescription: "هو: مګر محکمه باید عادلانه ، خپلواکه او بې طرفه وي او اساسی قضایي تضمینونه رعایت کړی. پرته له دې محاکمه نشی ترسره کیدلای.", questionImg: "assets/images/1222.jpg"),
  ...
  List<Question> questionBank252 = [
    Question(questionDescription: 'د یوه پلورنځي منشی تاسو ته وايي چې هغه غواړي ستاسو په سازمان کې برخه واخلي. ستاسو سازمان ژمنه کړې چې د ۱۸ کالو څخه کم عمر ماشومان ونه ګماري. تاسو پوښتنه کوئ چې هغه څو کلن دی. هغه وايي "۱۸". تاسو په ډاډ سره نشئ ویلی چې آیا هغه د ۱۶ یا ۱۸ کالو دی، خو تاسو نوی کسانو ته اړتیا لرئ، او که هغه داسې وايي نو…', question: "لومړۍ پوښتنه :آیا تاسو اړتیا لرئ د هغه د عمر تصدیق وکړئ؟", answer: true, answerDescription: "هو: د شک په صورت کې تاسو باید د ګمارل کېدونکی کس د عمر د تاییدولو لپاره اقدامات وکړئ.", questionImg: "assets/images/1521.jpg"),
    Question(questionDescription: "تاسو د هغه د زیږون د تصدیق پاڼه د لیدلو غوښتنه کوئ. هغه وايي چې نه یی لري، خو هغه د طبي معاينې ترسره کولو ته چمتو دی.", question: "دوهمه پوښتنه: آیا تاسو کولای شئ د عمر د اثبات په توګه د طبی ازموینې پایلې ومنئ؟", answer: false, answerDescription: "نه: طبي ارزونې د عمر د ثابتولو لپاره د کافی باور وړ ندي.", questionImg: "assets/images/1522.jpg"),
    Question(questionDescription: "هغه تاسو ته وايي چې هغه د داسې یو ولایت څخه راغلې دی چیرې چې په تیرو جګړو کې ټول سوابق له منځه تللي دی. مګر هغه کولای شي د کلي د وکیل، د خپل مور او پلار او د ښوونځي د ښوونکو څخه یادښتونه ترلاسه کړي.", question: "دریمه پوښتنه :که هغه دا ټول یادښتونه چمتو کړي، او دوی مستند وی، آیا تاسو کولای شئ دا هرڅه د عمر د ثبوت په توګه ومنئ؟", answer: true, answerDescription: "هو: که رسمي سندونه شتون ونلري، د عمر د تایید لپاره باید بیلابیلې سرچینې وکارول شي.", questionImg: "assets/images/1523.jpg"),
  ];
  ...
  List<Question> questionBank272_1 = [
    ...
    Question(questionDescription: 'تاسو د پهره دارۍ په حال کې یاست. تاسو یواځې د یوې ثانیې لپاره خوب وړي، کله چې تاسو په یو ناڅاپه حرکت پورته کیږی. تاسو د دښمن په جامو کې یوه کس ګورئ. هغه یو ټوپک لري او په ښکاره ډول ګزمه کوي.', question: "دوهمه پوښتنه: د وسله والې شخړې د قانون له مخې  آیا د دې اجازه ورکړل شوی چې نوموړی کس په نښه کړي؟", answer: true, answerDescription: "هو: هغه د دښمن د وسله والو ځواکونو غړیتوب لري. هغه له برید څخه خوندي ندی.", questionImg: "assets/images/17212.jpg"),
    Question(questionDescription: 'هغه کس تاسو وینی او د ځان د پټولو هڅه کوي. د هغه ټوپک د ونې په څانګه کې بندیږي. او هغه يې نشي لیرې کولای. هغه ځنګل ته تښتی او خپل ټوپک تر شا پرېږدي.', question: "دریمه پوښتنه: لکه څرنګه چې هغه خپله وسله له لاسه ورکړې، آیا تاسو اوس هم کولای شئ هغه په نښه کړئ؟", answer: true, answerDescription: "هو: هغه اوس هم د وسله والو ځواکونو غړی دی او په جګړو کې برخه اخلي.", questionImg: "assets/images/17213.jpg"),
  ];
  ...
  List<Question> questionBank275_1 = [
    ...
    Question(questionDescription: 'تاسو کمین نیسئ او بالآخره د جنرال په نیولو بریالی کیږئ. د هغه د تره زوی، چی یو نامتو دینی عالم دی، هم له هغه سره یو ځای په موټر کې دی. زکو وایی چې که تاسو هغه له ځان سره وساتئ نو دښمن به د مشهور دینی عالم د ژوبل کیدو پخاطر حمله ونه کړي. هغه وايي "د هیڅ ډول سرغړونو په اړه اندیښنه مه کوئ، زه به د هغه سره د شهزاده په توګه چلند وکړم او اجازه به ورنه کړم چې څوک ورته زیان ورسوی."', question: "دوهمه پوښتنه: که تاسو د دینی عالم سره ښه سلوک وکړئ، آیا تاسو کولای شئ هغه ددې لپاره وساتئ ترڅو دښمن لخوا ستاسو پر ځواکونو د برید مخه ونیول شی؟", answer: false, answerDescription: "نه: د انسانی ډال کارول منع دي.", questionImg: "assets/images/17512.jpg"),
